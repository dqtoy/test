...
public class FacebookManager : MonoBehaviour {
	...
	public void AddFriend (FriendData friend) { //2.1.2
	...
	public void SetPicture (string userID, Sprite sprite) {//2.1.2
		FriendData friendIndex = FacebookManager.Friends.Find (delegate (FriendData bk) {
...
//				linkName: FacebookSettings.AppLabels [0],
	...
	public void LoggedSuccefull () {//2.1.2
...
#if PLAYFAB || GAMESPARKS
			SetPicture (NetworkManager.UserID, InitScript.profilePic);//2.1.2
